(function ($) {
    ...
    **************************************************************/
    ...
    var MMViewManager = window["MMViewManager"] = function (options) {
        ...
        this.TRANSITION_SWIPE = 'swipe';
        this.TRANSITION_FADE = 'fade';
        ...
        this.getOptions = function () {
            ...
            var options = {
                ...
                defaultTransition: this.TRANSITION_SWIPE,
        ...
        this.build = function () {
            ...
            if (this.useTransforms) {
                ...
                this.transition = String('all ' + this.options.transitionDuration + 's ease-in-out 0s');
            }
        };
        ...
        this.addEvents = function () {
            ...
            $(document).on('tap', 'a[data-url]', function (evt) {
                ...
                /*if (this.inTransition) {
					...
					this.newViewTransition = targetTransition;
                //}
            } .bind(this));
        };
        ...
        this.activate = function () {
            ...
            mm.utils.log('MM INFO: "' + this.currentViewId + '" View loaded');
        ...
        this.changeView = function (viewId, viewUrl, viewTransition) {

            this.newViewUrl = viewUrl;
			this.newViewTransition = viewTransition;
        ...
        this.switchView = function (viewAdded, overrideTransitionTrigger) {
            ...
            if (viewAdded) {
                ...
                mm.utils.log('MM INFO: "' + this.newViewId + '" View created');
                ...
                mm.utils.log('MM INFO: "' + this.newViewId + '" View loaded');
        ...
        this.transitionViews = function () {
            ...
            if (this.transitionHolding) {
                ...
                var transitionSpec = this.getTransitionSpec(this.newViewTransition);
				this.newViewTransition = null;
                ...
                this.newView.css(jQuery.extend(viewDefaults, transitionSpec.newView.setup));
                this.currentView.css(jQuery.extend(viewDefaults, transitionSpec.currentView.setup));

                if (this.useTransforms) {

                    this.newView.css(transitionSpec.newView.start.css3);
                    this.currentView.css(transitionSpec.currentView.start.css3);
                }
                else {

                    this.newView.css(transitionSpec.newView.start.js);
                    this.currentView.css(transitionSpec.currentView.start.js);
                }
                ...
                if (this.useTransforms) {
                    ...
                    if (newViewTransform) {
                        mm.utils.css3.setTransitions(this.newView, this.transition);
                        this.newView.css(newViewTransform);
                    }
                    else if (currentViewTransform) {
                        mm.utils.css3.setTransitions(this.currentView, this.transition);
                        this.currentView.css(currentViewTransform);
                    }
                }
                else {
                    ...
                    if (newViewTransform) this.newView.animate(newViewTransform, this.options.transitionDuration * 1000, this.endTransition.bind(this))
                    else if (currentViewTransform) this.currentView.animate(currentViewTransform, this.options.transitionDuration * 1000, this.endTransition.bind(this))
                }
            }
            else {
                this.setViewHeights();
        ...
        this.endTransition = function (evt) {
			...
			this.currentView.css(mm.utils.css3.getTransform('none'));
			...
			this.newView.css(mm.utils.css3.getTransform('none'));
        ...
        this.getTransitionSpec = function (transitionType) {

            transitionType = (transitionType) ? transitionType : this.options.defaultTransition;
            ...
            switch (transitionType) {
                ...
                default:
                    ...
                    spec.newView.start.css3 = mm.utils.css3.getTransform('translateX(0)');
                    spec.newView.start.js = { 'left': 0 };

                    // Current View
                    spec.currentView.setup = { 'position': 'absolute', 'z-index': 100 }

                    spec.currentView.start.css3 = mm.utils.css3.getTransform('translateX(0)');
                    spec.currentView.start.js = { 'left': 0 };

                    spec.currentView.end.css3 = mm.utils.css3.getTransform('translateX(-100%)');
