    ...
    **************************************************************/
    ...
    var RangeSelector = window["RangeSelector"] = function (containerElem, options) {
        ...
        this.addEvents = function () {
            ...
            if (!this.options.maxOnly) {
                ...
                if (mm.utils.detect.touch()) {
                    ...
                    this.minMarker.on('touchstart', function (evt) {
                        this.startDrag(evt);
                    } .bind(this));
                }
                else {
            ...
            if (mm.utils.detect.touch()) {
                ...
                this.maxMarker.on('touchstart', function (evt) {
                    this.startDrag(evt);
                } .bind(this));
            }
            else {
            ...
            if (mm.utils.detect.touch()) {
                ...
                this.area.on('touchend', function (evt) {
                    this.endDrag(evt);
                } .bind(this));

                this.area.on('touchmove', function (evt) {
                    this.drag(evt);
                } .bind(this));
            }
            else {
        ...
        this.drag = function (evt) {
            ...
            if (mm.utils.detect.touch()) evt = evt.originalEvent.touches[0];
