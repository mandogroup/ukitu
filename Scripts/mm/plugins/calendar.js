    ...
    **************************************************************/
    ...
    var Calendar = window["Calendar"] = function (container, options) {
        ...
        this.init = function () {
            ...
            this.dateField = $(this.container.find('[data-date]')[0]);
        ...
        this.addEvents = function () {
            ...
            if (this.options.includeDayName) {
                ...
                if (Modernizr.touch) this.dayNameText.on('swipe', function (evt) { this.adjustDay(this.getAdjustment(evt.swipeDirection)); } .bind(this));
            }
            ...
            if (this.options.includeDay) {
                ...
                if (Modernizr.touch) this.dayText.on('swipe', function (evt) { this.adjustDay(this.getAdjustment(evt.swipeDirection)); } .bind(this));
            }
            ...
            if (Modernizr.touch) this.monthText.on('swipe', function (evt) { this.adjustMonth(this.getAdjustment(evt.swipeDirection)); } .bind(this));
            ...
            if (this.options.includeYear) {
                ...
                if (Modernizr.touch) this.yearText.on('swipe', function (evt) { this.adjustYear(this.getAdjustment(evt.swipeDirection)); } .bind(this));
            }
        };
