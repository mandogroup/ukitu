    ...
    **************************************************************/
    ...
    var MMViewOverlay = window["MMViewOverlay"] = function (options) {
        ...
        this.build = function () {
            ...
            if (this.options.enableFade && Modernizr.opacity) {

                this.overlay.css('opacity', 0);
            }

            if (this.options.enableFade && Modernizr.csstransitions) {
        ...
        this.addEvents = function () {
            ...
            if (this.options.enableFade && Modernizr.csstransitions) {
                ...
                this.overlay.on(mm.utils.css3.getTransEndEventName(), function (evt) {
        ...
        this.showOverlay = function (instantShow) {
            ...
            if (this.overlay.attr('data-state') == 'inactive') {
                ...
                if (this.options.enableFade && Modernizr.csstransitions && Modernizr.opacity) {

                    this.overlay[0].offsetWidth;
                    this.overlay.css('opacity', 1);
                }
                else if (this.options.enableFade && Modernizr.opacity) {
